...
# 📝 Publications 
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">AIEA 2024</div><img src='../../images/AIEA2024.png' alt="sym" width="50%"></div></div>
...
- [**Contribution**](https://github.com/Yuxin_Qiao/NewCLIPood) <strong><span class='show_paper_citations' data=''></span></strong>
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">Arxiv 2024</div><img src='../../images/llmrv.png' alt="sym" width="30%"></div></div>
<div class='paper-box-text' markdown="1">

[Large language models for forecasting and anomaly detection: A systematic literature review](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=6i-r0JIAAAAJ&citation_for_view=6i-r0JIAAAAJ:aqlVkmm33-oC) \

Jing Su, **Chufeng Jiang**, Xin Jin, Yuxin Qiao, Tingsong Xiao, Hongda Ma, Rong Wei, Zhi Jing, Jiajun Xu, Junhong Lin

[**Research Questions**]() <strong><span></span></strong>

- What methodologies are employed in LLMs for forecasting in different domains?
...
- How effective are LLMs in detecting anomalies compared to traditional anomaly detection methods?
...
- What are the limitations and challenges of using LLMs for forecasting and anomaly detection?
